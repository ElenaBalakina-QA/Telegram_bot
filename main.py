...
bot = TeleBot(token=telegram_bot_token, parse_mode='html') # создание бота
...
def message_handler(message: types.Message):
    ...
    if message.text == 'VISA':
        card_type = 'visa'
        img_name = '1920px-Visa_Electron.svg.png'
    elif message.text == 'Mastercard':
        card_type = 'mastercard'
        img_name = 'Mastercard-logo.svg.png'
    elif message.text == 'Maestro':
        card_type = 'maestro'
        img_name = 'Maestro_2016.svg.png'
    elif message.text == 'JCB':
        card_type = 'jcb'
        img_name = 'JCB_logo.svg.png'
    else:
    ...
    bot.send_photo(message.chat.id, img, caption=f'Тестовая карта {card_type}:\n<code>{card_number}</code>')
